...
import {
  RECTANGLE_WIDTH,
  RECTANGLE_FIRST_ZOOM_WIDTH,
  RECTANGLE_SECOND_ZOOM_WIDTH
  ...
  return (
    <Container
      ...
      style={{
        ...
        borderWidth: `${
          props.zoomScale >= 2 && props.zoomScale <= 3.5
            ? RECTANGLE_FIRST_ZOOM_WIDTH + "px"
            : props.zoomScale > 3.5 && props.zoomScale <= 8
            ? RECTANGLE_SECOND_ZOOM_WIDTH + "px"
            : RECTANGLE_WIDTH + "px"
        }`,
        ...props.style
      }}
