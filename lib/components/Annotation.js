...
exports.default = (0, _compose2.default)((0, _isMouseHovering2.default)(), (0, _withRelativeMousePos2.default)())((_temp2 = _class = function (_Component) {
  ...
  function Annotation() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.componentDidMount = function () {
      ...
      var intersections = annotations.map(function (annotation) {
        var geometry = annotation.comment_polygon.geometry;

        var selector = getSelectorByType(geometry.type);

        return selector.intersects({ x: x, y: y }, geometry, container) ? annotation.comment_polygon : false;
      }).filter(function (a) {
        return !!a;
      }).sort(function (a, b) {
  ...
  Annotation.prototype.render = function render() {
    ...
    var isMouseHovering = props.isMouseHovering,
        ...
        showActiveAnnotations = props.showActiveAnnotations,
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        props.annotations.map(function (annotation) {
          if (annotation.comment_polygon.geometry.type === _selectors.PolygonSelector.TYPE) {
            polygonAnnotation.push(annotation);
          } else {
            return renderHighlight({
              key: annotation.comment_polygon.data.id,
              annotation: annotation.comment_polygon,
              active: _this3.shouldAnnotationBeActive(annotation.comment_polygon, topAnnotationAtMouse),
              zoomScale: zoomScale
            });
          }
        }),
        props.annotations.map(function (annotation) {
          showActiveAnnotations(annotation.comment_polygon, _this3.shouldAnnotationBeActive(annotation.comment_polygon, topAnnotationAtMouse));
        }),
        _react2.default.createElement(
          'svg',
          { width: '100%', height: '100%' },
          polygonAnnotation.map(function (annotation) {
            return renderHighlight({
              key: annotation.comment_polygon.data.id,
              annotation: annotation.comment_polygon,
              active: _this3.shouldAnnotationBeActive(annotation.comment_polygon, topAnnotationAtMouse),
          ...
          !props.disableSelector && props.value && props.value.geometry && (props.value.geometry.type === _selectors.PolygonSelector.TYPE ?
      ...
      props.annotations.map(function (annotation) {
        return _this3.shouldAnnotationBeActive(annotation.comment_polygon, topAnnotationAtMouse) && renderContent({
          key: annotation.comment_polygon.data.id,
          annotation: annotation.comment_polygon,
  ...
  showActiveAnnotations: _propTypes2.default.func.isRequired,
  zoomScale: _propTypes2.default.number.isRequired
