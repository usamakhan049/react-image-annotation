...
function Content(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      {
        style: {
          fontSize: props.zoomScale >= 2 && props.zoomScale <= 3.5 ? 10 : props.zoomScale > 3.5 && props.zoomScale <= 8 ? 6 : 12,
          paddingRight: props.zoomScale >= 2 && props.zoomScale <= 3.5 ? 3 : props.zoomScale > 3.5 && props.zoomScale <= 8 ? 2 : 8,
          paddingLeft: props.zoomScale >= 2 && props.zoomScale <= 3.5 ? 3 : props.zoomScale > 3.5 && props.zoomScale <= 8 ? 2 : 8 }
