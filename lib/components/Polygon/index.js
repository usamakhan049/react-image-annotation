...
function Polygon(props) {
  ...
  return (
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('circle', { style: { fill: "#00bfa5" }, cx: getCentroid(geometry)[0] + "% ", cy: getCentroid(geometry)[1] + "%", r: '1.1' }),
      _react2.default.createElement(
        'text',
        { x: getCentroid(geometry)[0] + "% ", y: getCentroid(geometry)[1] + "%", style: { fontSize: "1.2px", fontWeight: "bold" }, 'text-anchor': 'middle', fill: 'white', dy: '.3em' },
        data.id
      )
    )
  );
