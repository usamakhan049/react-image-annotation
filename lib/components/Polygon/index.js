    ...
    _react2.default.createElement(
      ...
      geometry.points.length >= 3 && geometry.points.map(function (item, i) {
        ...
        return (
          ...
          _react2.default.createElement('line', { x1: item.x + "%", y1: item.y + "%", x2: prevItem.x + "%", y2: prevItem.y + "%", stroke: '#1976d2', 'stroke-width': '3px', className: 'polygon-line' })
      ...
      geometry.points.map(function (item, i) {
        ...
        return (
          ...
          //   }}
          // />
          _react2.default.createElement('circle', { cx: item.x + "% ", cy: item.y + "%", r: '1', stroke: 'white', 'stroke-width': '1', fill: 'white' })
        );
      })
    )
  );
